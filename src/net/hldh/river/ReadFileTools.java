...
import net.hldh.river.ExecuteTimerHandler;
import net.hldh.river.IReadFileTools;
...
//        String file = root + "VISA_INPUT_FULL";
        String file = "F:\\小猫钓鱼.mp4";       //146479KB
        ExecuteTimerHandler et = new ExecuteTimerHandler();
        IReadFileTools bi = (IReadFileTools) et.bind(new ReadFileTools());
